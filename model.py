...
class Votes(db.Model):
    ...
    vote_choice_first = db.Column("first choice", db.String(100))
    vote_choice_second = db.Column("second choice", db.String(100))
    vote_choice_third = db.Column("third choice", db.String(100))
